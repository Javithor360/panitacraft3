...
public class DifficultyService {
    ...
    public static double getChronologicDifficulty(boolean skipCache) {
        ...
        if (!skipCache && (now - lastChronologicCalculation < DifficultyConfig.getDelayBetweenChecks())) {
    ...
    public static double getLocalDifficulty(Location context) {
        ...
        return autoGeneratedDifficulty * DifficultyConfig.getManualMultiplier(); // Final difficulty can exceed the max fixed difficulty
    }
    ...
    public static double getIndividualDifficulty(Player player, boolean skipCache) {
        ...
        if (!skipCache && individualDifficultyCache.containsKey(uuid)) {
            ...
            if (now - cached.timestamp < DifficultyConfig.getDelayBetweenChecks()) {
                return cached.value;
            }
        }
