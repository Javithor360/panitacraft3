...
/**
 * This class modifies the attack damage of certain mobs based on the difficulty level.
 */
public class AttackDamageModifier implements MobModifier {
    ...
    public boolean canApply(LivingEntity entity) {
        return APPLICABLE_ENTITIES.contains(entity.getType()) &&
                DifficultyCurveUtil.ensureAttributeExists(entity, Attribute.ATTACK_DAMAGE, 1.0);
    }
